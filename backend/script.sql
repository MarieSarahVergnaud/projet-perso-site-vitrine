...
INSERT INTO `mara_oeuvres` (titre, description, technique, portecle, taille, image) VALUES
    ...
    ('Totoro', 'Gros Totoro avec une feuille sur la tête', 'laine feutrée', false, 'grand', 'http://localhost:5000/assets/image_card/totoro-gros-lainefeutrée.JPG'),
    ...
    ('Totoro', 'Petit Totoro version porte cle', 'laine feutrée', true, 'grand', 'http://localhost:5000/assets/image_card/totoro-gros-lainefeutrée.JPG');
